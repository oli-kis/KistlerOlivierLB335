    ...
    return(
        <View style={styles.audioControlls}>
            <TouchableOpacity onPress={() => props.handlePlayPause(index)}>
              <Image style={styles.playControlls} source={playbackStatuses[index]?.playing ? require("../assets/pause.png") : require("../assets/play.png")}></Image>
            </TouchableOpacity>
            ...
            <Slider
              ...
              value={
                ...
                playbackStatuses[index]?.duration
                  ? 0
                  : playbackStatuses[index]?.position
              }
